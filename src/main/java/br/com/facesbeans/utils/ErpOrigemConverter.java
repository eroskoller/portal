...
import br.com.hibernate.entities.ErpOrigem;
 ...
 * @author eros
 */
@FacesConverter(value="erporigemconverter")
public class ErpOrigemConverter implements Serializable ,Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        if (submittedValue.trim().equals("")) {
            ...
            try {
                ...
                xstream.alias("ErpOrigem", ErpOrigem.class);
                return  (ErpOrigem) xstream.fromXML(submittedValue);
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((ErpOrigem) value).toString());
        }
    }
