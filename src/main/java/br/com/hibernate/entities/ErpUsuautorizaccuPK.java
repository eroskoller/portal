 ...
 */
@Embeddable
public class ErpUsuautorizaccuPK implements Serializable {
    ...
    public ErpUsuautorizaccuPK() {
    }

    public ErpUsuautorizaccuPK(String usuStCodigo, String ccuStCodigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErpUsuautorizaccuPK)) {
            return false;
        }
        ErpUsuautorizaccuPK other = (ErpUsuautorizaccuPK) object;
    ...
    public String toString() {
        return "br.com.hibernate.entities.ErpUsuautorizaccuPK[ usuStCodigo=" + usuStCodigo + ", ccuStCodigo=" + ccuStCodigo + " ]";
    }
