 ...
 */
@Embeddable
public class ErpUsuautorizacompraPK implements Serializable {
    ...
    public ErpUsuautorizacompraPK() {
    }

    public ErpUsuautorizacompraPK(String usuStCodigo, String ccuStCodigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErpUsuautorizacompraPK)) {
            return false;
        }
        ErpUsuautorizacompraPK other = (ErpUsuautorizacompraPK) object;
    ...
    public String toString() {
        return "br.com.hibernate.entities.ErpUsuautorizacompraPK[ usuStCodigo=" + usuStCodigo + ", ccuStCodigo=" + ccuStCodigo + " ]";
    }
