...
//    private List<LabRequisicao> listLabRequisicao;
    ...
    public LabConvenio(String conStCodigo) {
        this.conStCodigo = conStCodigo;
    }

    public LabConvenio(String conStCodigo, String conStDescricao) {
        this.conStCodigo = conStCodigo;
    ...
    public boolean equals(Object obj) {
        ...
        final LabConvenio other = (LabConvenio) obj;
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + (this.conStCodigo != null ? this.conStCodigo.hashCode() : 0);
        return hash;
    }
