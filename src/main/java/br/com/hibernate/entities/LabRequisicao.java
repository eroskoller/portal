...
//    private LabAgendaPaciente agpInCodigo;
    ...
    public LabRequisicao(Long reqInCodigo, String reqStCodigo, String uniStCodigo, LabPaciente pacInCodigo, Date reqDtCadastro, Date reqHrCadastro) {
        this.reqInCodigo = reqInCodigo;
        this.reqStCodigo = reqStCodigo;
...
//    }
    ...
    public LabSolicitante getBuscaLabSolicitante(){
        if(this.solStCodigo != null  && strDbName != null ){
            if(buscaLabSolicitante == null){
                 buscaLabSolicitante =  (LabSolicitante) OracleHelper.getObjectByKey(LabSolicitante.class, "solStCodigo",solStCodigo,strDbName);//TODO properlly solve multi dbs
...
public LabColetor getBuscaLabColetor(){
    if(colStCodigo != null && uniStCodigo != null){
        if(buscaLabColetor == null  && strDbName != null ){
              buscaLabColetor = OracleHelper.getLabColetorByColStCodigo_UniStCodigo(this.colStCodigo, uniStCodigo,strDbName);//TODO properlly solve multi dbs
