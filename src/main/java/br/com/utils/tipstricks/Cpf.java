    ...
    public static String gettingDigits(String str){
     ...
     public void validate(FacesContext context, UIComponent component, Object value){
         ...
         if(!isCpf){
            ...
            message.setDetail("Cpf nâo é valido");
            message.setSummary("Formato de cpf nâo é valido");
...
//                 FacesMessage message = new FacesMessage();
//                message.setDetail("Cpf j� existente no sistema.");
//                message.setSummary("Cpf j� existente no sistema.");
//                message.setSeverity(FacesMessage.SEVERITY_ERROR);
//                throw new ValidatorException(message);
//
//             }
